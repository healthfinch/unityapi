class UnityClient
  ...
  def echo(param_1, param_2, param_3, param_4, param_5, param_6)
    response = magic_action(self.user, self.pass, self.appname, param_1, param_2, param_3, param_4, param_5, param_6)
